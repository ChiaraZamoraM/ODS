...
## Merge
```{r}
ODS_2 = Reduce(function(x, y) merge(x, y, by= "DEPARTAMENTO"), list(X2_1_1,X2_2_1,X2_2_2))
...
X3_a_1_R = X3_a_1_R[c(10:nrow(X3_a_1_R)),c(1,9)]
colnames()
names(X3_a_1) = paste0("ODS3_a_1_",names(X3_a_1))

X3_a_1 =  merge(X3_a_1, X3_a_1_R)
```
...
Agua limpia y saneamiento	6.2.1 Proporción de la población que utiliza servicios de saneamiento gestionados sin riesgos
Agua limpia y saneamiento	6.3.1 Proporción de hogares con agua tratada
