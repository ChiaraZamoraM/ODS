...
## Merge ODS 5
```{r}
ODS_5 = Reduce(function(x, y) merge(x, y, by= "DEPARTAMENTO",all=TRUE), list(X5_2_1,X5_5_1,
                                                                             X5_5_2,X5_5_3,
                                                                             X5_5_4))
...
# Merge
```{r}
ODS = Reduce(function(x, y) merge(x, y, by= "DEPARTAMENTO",all=TRUE), list(ODS_1,ODS_2, ODS_3, ODS_4, ODS_5, ODS_6))
